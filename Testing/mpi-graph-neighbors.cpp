/*
MPI_Graph_neighbors retrieves the list of neighbours (a.k.a adjacency list) of a given MPI process in a communicator with graph topology, as created per MPI_Graph_create. The adjacency list retrieved is identical to the one passed during the creation; especially, the order and any duplicate are preserved.
*/

/**
 * @author RookieHPC
 * @brief Original source code at https://www.rookiehpc.com/mpi/docs/mpi_graph_neighbors.php
 **/
