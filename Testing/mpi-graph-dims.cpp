/*
MPI_Graphdims_get retrieves the number of nodes and edges of a communicator with graph topology created by MPI_Graph_create.
*/

/**
 * @author RookieHPC
 * @brief Original source code at https://www.rookiehpc.com/mpi/docs/mpi_graphdims_get.php
 **/
