/*
MPI_Graph_get allows to retrieve the indexes and edges of a communicator with graph topology, as created by MPI_Graph_create. Typically, MPI_Graphdims_get is called first to retrieve the number of indexes and edges, then allowing to call MPI_Graph_get.
*/

/**
 * @author RookieHPC
 * @brief Original source code at https://www.rookiehpc.com/mpi/docs/mpi_graph_get.php
 **/
