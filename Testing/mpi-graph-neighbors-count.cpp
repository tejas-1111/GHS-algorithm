/*
MPI_Graph_neighbors_count retrieves the number of neighbours for a given rank in the communicator with graph topology passed (which will have been created with MPI_Graph_create).
*/

/**
 * @author RookieHPC
 * @brief Original source code at https://www.rookiehpc.com/mpi/docs/mpi_graph_neighbors_count.php
 **/
